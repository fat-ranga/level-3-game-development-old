...
#ifndef MANUKA_TEST_NODE_2D_H
#define MANUKA_TEST_NODE_2D_H

// Godot stuff we can use.
...
namespace manuka
{
	...
	public:
		// Out small test method, implementation in cpp file.
		//virtual void say_hello(const String& what);
		// Define constructor and deconstructor.
		TestNode2D();
		~TestNode2D();

		void say_hello(const String& what);

	};
}

#endif // MANUKA_TEST_NODE_2D_H